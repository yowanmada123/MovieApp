...
String detailChannelToJson(DetailChannel data) => json.encode(data.toJson());
...
class DetailChannel {
  ...
  factory DetailChannel.fromJson(Map<String, dynamic> json) => DetailChannel(
        ...
        numberOfEpisodes: json["number_of_episodes"] ?? 123,
        numberOfSeasons: json["number_of_seasons"] ?? 123,
        originCountry: List<String>.from(json["origin_country"].map((x) => x)),
        originalLanguage: json["original_language"] ?? "",
        originalName: json["original_name"] ?? "",
        overview: json["overview"] ?? "",
        popularity: json["popularity"]?.toDouble() ?? 123,
        ...
        type: json["type"] ?? "",
        voteAverage: json["vote_average"]?.toDouble() ?? 123,
        voteCount: json["vote_count"] ?? 123,
      );
...
class TEpisodeToAir {
  ...
  factory TEpisodeToAir.fromJson(Map<String, dynamic> json) => TEpisodeToAir(
        ...
        name: json["name"] ?? "",
        overview: json["overview"] ?? "",
        voteAverage: json["vote_average"] ?? 123,
        voteCount: json["vote_count"] ?? 123,
        airDate: json["air_date"] ?? "",
        episodeNumber: json["episode_number"] ?? 123,
        productionCode: json["production_code"] ?? 123,
        runtime: json["runtime"] ?? 123,
        seasonNumber: json["season_number"] ?? 123,
        showId: json["show_id"] ?? 123,
...
class Season {
  ...
  factory Season.fromJson(Map<String, dynamic> json) => Season(
        airDate: json["air_date"] ?? "",
        episodeCount: json["episode_count"] ?? 123,
        id: json["id"] ?? 123,
        name: json["name"] ?? "",
        overview: json["overview"] ?? "",
        posterPath: json["poster_path"] ?? "",
